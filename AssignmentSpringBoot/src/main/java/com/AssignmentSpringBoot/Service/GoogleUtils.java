...
public class GoogleUtils {
	...
	public String getToken(final String code) throws IOException {
		...
		String response = Request.Post(link).bodyForm(Form.form().add("client_id", env.getProperty("google.app.id"))
	...
	public UserDetails builUser(GooglePojo googlePojo) {
		...
		UserDetails userDetail = new User(googlePojo.getEmail(), "", enabled, accountNonExpired, credentialsNonExpired, accountNonLocked,authorities);
		return userDetail;
	}
}
